...
tracer = Tracer(service="start_bankslip_analysis")
logger = Logger()
metrics = Metrics()
    ...
    try:
        ...
        for record in event["Records"]:
            ...
            for rec in s3_event["Records"]:
                job_id = textract.start_document_analysis(rec["s3"]["bucket"]["name"], rec["s3"]["object"]["key"], textract_notification_topic, textract_notification_role)
